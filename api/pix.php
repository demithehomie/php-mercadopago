...
if ($payCreate) {
    ...
    if (isset($obj->id)) {
        if ($obj->id != NULL) {
            ...
            echo "<img src='data:image/png;base64, {$img_qrcode}' width='200' style='display: flex; margin: auto; align-items: center; justify-content: center;' /> <br />";
            echo "<textarea style='display: flex; margin: auto; align-items: center; justify-content: center;'>{$copia_cola}</textarea> <br />";
            echo "<a style='display: flex; margin: auto; align-items: center; justify-content: center;' href='{$link_externo}' target='_blank' >Link externo</a>";
